...
<template>
    <span class="w-full flex justify-start items-center transition-all duration-300">
        <span
        ...
        >        
            <span v-if="open" class="w-full pl-2 flex justify-start items-center">                    
                <p class="text-violet-600  m-0">{{ value ? 'true' : 'false' }}</p>
            </span>
        </transition>
    </span>
</template>